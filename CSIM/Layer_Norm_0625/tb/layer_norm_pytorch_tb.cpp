...
int main()
{
    string basedir = "/home/ytq/codeField/temp_MM_Accelerator/insn/GCN/whole_gcn/3/";
    ...
    ap_uint<32> beta_addr = gama_addr + COLS * sizeof(t_InpDataType);
    ...
    readBin(basedir + "dram.bin", sizeof(t_InpDataType) * ROWS * COLS * 2 + sizeof(t_InpDataType) * COLS * 2, input_data);
    readBin(basedir + "dram_after.bin", sizeof(t_OutDataType) * ROWS * COLS, golden);
