...
entity layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond7_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ln_paras_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal loop_index_load_reg_142 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ln_paras_addr_read_reg_147 : STD_LOGIC_VECTOR (255 downto 0);
    signal loop_index_cast_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal loop_index_fu_62 : STD_LOGIC_VECTOR (26 downto 0);
    signal empty_fu_114_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index_load : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond7_fu_120_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1))) then 
                    loop_index_fu_62 <= empty_fu_114_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_fu_62 <= ap_const_lv27_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, exitcond7_fu_120_p2, ap_start_int)
    begin
        if (((exitcond7_fu_120_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index_load <= ap_const_lv27_0;
        else 
            ap_sig_allocacmp_loop_index_load <= loop_index_fu_62;
        end if; 
    end process;

    beta_ram_address0 <= loop_index_cast_fu_131_p1(9 - 1 downto 0);

    beta_ram_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    beta_ram_d0 <= ln_paras_addr_read_reg_147;

    beta_ram_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            beta_ram_we0 <= ap_const_lv32_FFFFFFFF;
        else 
            beta_ram_we0 <= ap_const_lv32_0;
        end if; 
    end process;

    empty_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv27_1));
    exitcond7_fu_120_p2 <= "1" when (empty_fu_114_p2 = lshr_ln) else "0";
    ...
    loop_index_cast_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_index_load_reg_142),64));
