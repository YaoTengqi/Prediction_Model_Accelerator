set moduleName p_anonymous_namespace_DataMover_A_ap_int_ap_uint_5u_Pipeline_VITIS_LOOP_35_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {(anonymous namespace)DataMover_A<ap_int,ap_uint,5u>_Pipeline_VITIS_LOOP_35_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ ln_data int 256 regular {axi_master 0}  }
	{ sext_ln35 int 59 regular  }
	{ rows int 32 regular  }
	{ trunc_ln int 9 regular  }
	{ trunc_ln4 int 9 regular  }
	{ ram_V int 256 regular {array 512 { 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ln_data", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "inputs","offset": { "type": "dynamic","port_name": "inputs","bundle": "ln_addr"},"direction": "READONLY"},{"cName": "outputs","offset": { "type": "dynamic","port_name": "outputs","bundle": "ln_addr"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln35", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ram_V", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_ln_data_AWLEN sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_ln_data_ARLEN sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_ln_data_RFIFONUM sc_in sc_lv 13 signal 0 } 
	...
	{ sext_ln35 sc_in sc_lv 59 signal 1 } 
	{ rows sc_in sc_lv 32 signal 2 } 
	{ trunc_ln sc_in sc_lv 9 signal 3 } 
	{ trunc_ln4 sc_in sc_lv 9 signal 4 } 
	{ ram_V_address0 sc_out sc_lv 9 signal 5 } 
	{ ram_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ ram_V_we0 sc_out sc_logic 1 signal 5 } 
	{ ram_V_d0 sc_out sc_lv 256 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln35", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln35", "role": "default" }} , 
 	...
 	{ "name": "ram_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ram_V", "role": "we0" }} , 
 	{ "name": "ram_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "ram_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln35 { ap_none {  { sext_ln35 in_data 0 59 } } }
	rows { ap_none {  { rows in_data 0 32 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 9 } } }
	trunc_ln4 { ap_none {  { trunc_ln4 in_data 0 9 } } }
	ram_V { ap_memory {  { ram_V_address0 mem_address 1 9 }  { ram_V_ce0 mem_ce 1 1 }  { ram_V_we0 mem_we 1 1 }  { ram_V_d0 mem_din 1 256 } } }
}
