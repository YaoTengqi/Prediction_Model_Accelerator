...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename gamma_ram \
    op interface \
    ports { gamma_ram_address0 { O 9 vector } gamma_ram_ce0 { O 1 bit } gamma_ram_we0 { O 32 vector } gamma_ram_d0 { O 256 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'gamma_ram'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln96 \
    op interface \
    ports { add_ln96 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_ln96_cast \
    op interface \
    ports { sub_ln96_cast { I 5 vector } } \
} "
}
