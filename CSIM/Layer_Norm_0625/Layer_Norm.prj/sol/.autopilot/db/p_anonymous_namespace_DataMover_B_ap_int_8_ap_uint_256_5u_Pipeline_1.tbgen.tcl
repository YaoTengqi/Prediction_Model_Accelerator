set moduleName p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {(anonymous namespace)DataMover_B<ap_int<8>, ap_uint<256>, 5u>_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ ln_paras int 256 regular {axi_master 0}  }
	{ p_cast_cast int 59 regular  }
	{ gamma_ram int 256 regular {array 512 { 0 } 0 1 }  }
	{ lshr_ln int 27 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ln_paras", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "paras","offset": { "type": "dynamic","port_name": "paras","bundle": "ln_addr"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "p_cast_cast", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "gamma_ram", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "lshr_ln", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_ln_paras_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_AWADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_ln_paras_AWID sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_AWLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_ln_paras_AWSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_ln_paras_AWBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_AWLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_AWCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_AWPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_ln_paras_AWQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_AWREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_AWUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_WVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_WREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_WDATA sc_out sc_lv 256 signal 0 } 
	{ m_axi_ln_paras_WSTRB sc_out sc_lv 32 signal 0 } 
	{ m_axi_ln_paras_WLAST sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_WID sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_WUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_ARVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_ARREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_ARADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_ln_paras_ARID sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_ARLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_ln_paras_ARSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_ln_paras_ARBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_ARLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_ARCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_ARPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_ln_paras_ARQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_ARREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_ln_paras_ARUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_RVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_RREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_RDATA sc_in sc_lv 256 signal 0 } 
	{ m_axi_ln_paras_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_RFIFONUM sc_in sc_lv 13 signal 0 } 
	{ m_axi_ln_paras_RUSER sc_in sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_RRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_BVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_BREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_ln_paras_BRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_ln_paras_BID sc_in sc_lv 1 signal 0 } 
	{ m_axi_ln_paras_BUSER sc_in sc_lv 1 signal 0 } 
	{ p_cast_cast sc_in sc_lv 59 signal 1 } 
	{ gamma_ram_address0 sc_out sc_lv 9 signal 2 } 
	{ gamma_ram_ce0 sc_out sc_logic 1 signal 2 } 
	{ gamma_ram_we0 sc_out sc_lv 32 signal 2 } 
	{ gamma_ram_d0 sc_out sc_lv 256 signal 2 } 
	{ lshr_ln sc_in sc_lv 27 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_cast_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "p_cast_cast", "role": "default" }} , 
 	{ "name": "gamma_ram_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "gamma_ram", "role": "address0" }} , 
 	{ "name": "gamma_ram_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gamma_ram", "role": "ce0" }} , 
 	{ "name": "gamma_ram_we0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gamma_ram", "role": "we0" }} , 
 	{ "name": "gamma_ram_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "gamma_ram", "role": "d0" }} , 
 	{ "name": "lshr_ln", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "lshr_ln", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	p_cast_cast { ap_none {  { p_cast_cast in_data 0 59 } } }
	gamma_ram { ap_memory {  { gamma_ram_address0 mem_address 1 9 }  { gamma_ram_ce0 mem_ce 1 1 }  { gamma_ram_we0 mem_we 1 32 }  { gamma_ram_d0 mem_din 1 256 } } }
	lshr_ln { ap_none {  { lshr_ln in_data 0 27 } } }
}
