...
entity layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_1 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond9_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ln_paras_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal loop_index4_load_reg_142 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ln_paras_addr_read_reg_147 : STD_LOGIC_VECTOR (255 downto 0);
    signal loop_index4_cast_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal loop_index4_fu_62 : STD_LOGIC_VECTOR (26 downto 0);
    signal empty_fu_114_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index4_load : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    ...
    loop_index4_fu_62_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond9_fu_120_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1))) then 
                    loop_index4_fu_62 <= empty_fu_114_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index4_fu_62 <= ap_const_lv27_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                loop_index4_load_reg_142 <= ap_sig_allocacmp_loop_index4_load;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_ln_paras_RVALID, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= ((m_axi_ln_paras_RVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_ln_paras_RVALID, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= ((m_axi_ln_paras_RVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(m_axi_ln_paras_RVALID)
    begin
                ap_block_state1_pp0_stage0_iter0 <= (m_axi_ln_paras_RVALID = ap_const_logic_0);
    end process;

        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, exitcond9_fu_120_p2, ap_start_int)
    begin
        if (((exitcond9_fu_120_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index4_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, loop_index4_fu_62, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index4_load <= ap_const_lv27_0;
        else 
            ap_sig_allocacmp_loop_index4_load <= loop_index4_fu_62;
        end if; 
    end process;

    empty_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index4_load) + unsigned(ap_const_lv27_1));
    exitcond9_fu_120_p2 <= "1" when (empty_fu_114_p2 = lshr_ln) else "0";
    gamma_ram_address0 <= loop_index4_cast_fu_131_p1(9 - 1 downto 0);

    gamma_ram_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    gamma_ram_d0 <= ln_paras_addr_read_reg_147;

    gamma_ram_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            gamma_ram_we0 <= ap_const_lv32_FFFFFFFF;
        else 
    ...
    ln_paras_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, m_axi_ln_paras_RVALID, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    loop_index4_cast_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_index4_load_reg_142),64));
    m_axi_ln_paras_ARADDR <= ap_const_lv64_0;
    m_axi_ln_paras_ARBURST <= ap_const_lv2_0;
    m_axi_ln_paras_ARCACHE <= ap_const_lv4_0;
    m_axi_ln_paras_ARID <= ap_const_lv1_0;
    m_axi_ln_paras_ARLEN <= ap_const_lv32_0;
    ...
    m_axi_ln_paras_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
