...
entity layernorm_fifo_w256_d16_A is
    generic (
...
architecture arch of layernorm_fifo_w256_d16_A is

    -- component
    component layernorm_fifo_w256_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_layernorm_fifo_w256_d16_A_ram : layernorm_fifo_w256_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity layernorm_fifo_w256_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 256;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of layernorm_fifo_w256_d16_A_ram is
