...
module layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond9_fu_120_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    ln_paras_blk_n_R;
wire    ap_block_pp0_stage0;
reg   [26:0] loop_index4_load_reg_142;
reg    ap_block_pp0_stage0_11001;
reg   [255:0] ln_paras_addr_read_reg_147;
wire   [63:0] loop_index4_cast_fu_131_p1;
reg   [26:0] loop_index4_fu_62;
wire   [26:0] empty_fu_114_p2;
wire    ap_loop_init;
reg   [26:0] ap_sig_allocacmp_loop_index4_load;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond9_fu_120_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
            loop_index4_fu_62 <= empty_fu_114_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index4_fu_62 <= 27'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond9_fu_120_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index4_load = 27'd0;
    end else begin
...
assign empty_fu_114_p2 = (ap_sig_allocacmp_loop_index4_load + 27'd1);

assign exitcond9_fu_120_p2 = ((empty_fu_114_p2 == lshr_ln) ? 1'b1 : 1'b0);

assign gamma_ram_address0 = loop_index4_cast_fu_131_p1;

assign gamma_ram_d0 = ln_paras_addr_read_reg_147;

assign loop_index4_cast_fu_131_p1 = loop_index4_load_reg_142;
...
endmodule //layernorm_p_anonymous_namespace_DataMover_B_ap_int_8_ap_uint_256_5u_Pipeline_1
