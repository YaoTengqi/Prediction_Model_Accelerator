...
set Library     "hls"
set IPName      "layernorm"
set Version     "1.0"
set DisplayName "Layernorm"
set Revision    "2113617833"
...
set xo_kernel_name "layernorm"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Layer_Norm_0612/Layer_Norm.prj/sol"
set debug_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Layer_Norm_0612/Layer_Norm.prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {layernorm_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_ln_addr m_axi_ln_data m_axi_ln_paras"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ln_data {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 64 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_WRITE HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "ln_data"
        ctype {
            AWLEN {
                Type "integer unsigned"
        ...
        data_width "256"
        port_prefix "m_axi_ln_data"
        param_prefix "C_M_AXI_LN_DATA"
        ...
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ln_addr"
    }
    m_axi_ln_paras {
        type "native_axim"
        busTypeName "aximm"
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 64 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "ln_paras"
        ctype {
            AWLEN {
                Type "integer unsigned"
        ...
        data_width "256"
        port_prefix "m_axi_ln_paras"
        param_prefix "C_M_AXI_LN_PARAS"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ln_addr"
