...
set name reshape_mul_32s_32s_32_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler reshape_read_inputs_ap_uint_256_ap_int_8_32u_s_ram_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_in1_din { O 256 vector } data_in1_num_data_valid { I 5 vector } data_in1_fifo_cap { I 5 vector } data_in1_full_n { I 1 bit } data_in1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_input_data_addr \
    op interface \
    ports { input_data_addr { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 12 \
    name input_data_addr_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_input_data_addr_c \
    op interface \
    ports { input_data_addr_c_din { O 32 vector } input_data_addr_c_num_data_valid { I 3 vector } input_data_addr_c_fifo_cap { I 3 vector } input_data_addr_c_full_n { I 1 bit } input_data_addr_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ROWS_c9 \
    op interface \
    ports { ROWS_c9_din { O 32 vector } ROWS_c9_num_data_valid { I 2 vector } ROWS_c9_fifo_cap { I 2 vector } ROWS_c9_full_n { I 1 bit } ROWS_c9_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_COLS_c10 \
    op interface \
    ports { COLS_c10_din { O 32 vector } COLS_c10_num_data_valid { I 2 vector } COLS_c10_fifo_cap { I 2 vector } COLS_c10_full_n { I 1 bit } COLS_c10_write { O 1 bit } } \
} "
}
