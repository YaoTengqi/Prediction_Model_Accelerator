; ModuleID = '/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Reshape_HLS/Reshape_HLS.prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_reshape_ir(i32 %input_data_addr, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly %inputs, %"struct.ap_uint<256>"* noalias nocapture nonnull %outputs, i32 %ROWS, i32 %COLS, i1* noalias nocapture nonnull dereferenceable(1) %reshape_flag) local_unnamed_addr #0 {
entry:
  %inputs_copy = alloca i256, align 512
  %outputs_copy = alloca i256, align 512
  %reshape_flag_copy = alloca i1, align 512
  call fastcc void @copy_in(%"struct.ap_uint<256>"* nonnull %inputs, i256* nonnull align 512 %inputs_copy, %"struct.ap_uint<256>"* nonnull %outputs, i256* nonnull align 512 %outputs_copy, i1* nonnull %reshape_flag, i1* nonnull align 512 %reshape_flag_copy)
  call void @apatb_reshape_hw(i32 %input_data_addr, i256* %inputs_copy, i256* %outputs_copy, i32 %ROWS, i32 %COLS, i1* %reshape_flag_copy)
  call void @copy_back(%"struct.ap_uint<256>"* %inputs, i256* %inputs_copy, %"struct.ap_uint<256>"* %outputs, i256* %outputs_copy, i1* %reshape_flag, i1* %reshape_flag_copy)
  ret void
}
...
declare void @apatb_reshape_hw(i32, i256*, i256*, i32, i32, i1*)
...
define void @reshape_hw_stub_wrapper(i32, i256*, i256*, i32, i32, i1*) #4 {
entry:
  %6 = alloca %"struct.ap_uint<256>"
  %7 = alloca %"struct.ap_uint<256>"
  call void @copy_out(%"struct.ap_uint<256>"* %6, i256* %1, %"struct.ap_uint<256>"* %7, i256* %2, i1* null, i1* %5)
  call void @reshape_hw_stub(i32 %0, %"struct.ap_uint<256>"* %6, %"struct.ap_uint<256>"* %7, i32 %3, i32 %4, i1* %5)
  call void @copy_in(%"struct.ap_uint<256>"* %6, i256* %1, %"struct.ap_uint<256>"* %7, i256* %2, i1* null, i1* %5)
  ret void
}

declare void @reshape_hw_stub(i32, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, i32, i32, i1*)
