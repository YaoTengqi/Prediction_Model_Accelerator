...
set IPName      "reshape"
set Version     "1.0"
set DisplayName "Reshape"
set Revision    "2113557579"
...
set xo_kernel_name "reshape"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Reshape_HLS/Reshape_HLS.prj/sol"
set debug_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Reshape_HLS/Reshape_HLS.prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {reshape_mul_32s_32s_32_1_1
reshape_read_inputs_ap_uint_256_ap_int_8_32u_s_ram_RAM_AUTO_1R1W
reshape_flow_control_loop_pipe_sequential_init
reshape_flow_control_loop_pipe_sequential_init
...
reshape_flow_control_loop_pipe_sequential_init
reshape_fifo_w64_d4_S
reshape_fifo_w256_d16_A
reshape_fifo_w32_d3_S
reshape_fifo_w32_d2_S
reshape_fifo_w32_d2_S
reshape_fifo_w256_d16_A
reshape_fifo_w32_d2_S
reshape_fifo_w32_d2_S
reshape_start_for_store_ap_uint_256_ap_int_8_ap_int_8_32u_U0
reshape_start_for_reshape_stream_ap_int_8_ap_int_8_32u_U0
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_reshape_addr m_axi_reshape_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_reshape_data {
        ...
        data_width "256"
        port_prefix "m_axi_reshape_data"
        param_prefix "C_M_AXI_RESHAPE_DATA"
        ...
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_reshape_addr"
    }
}
