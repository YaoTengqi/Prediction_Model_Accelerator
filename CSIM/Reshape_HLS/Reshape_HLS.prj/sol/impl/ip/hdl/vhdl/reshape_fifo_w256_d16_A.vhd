...
entity reshape_fifo_w256_d16_A is
    generic (
...
architecture arch of reshape_fifo_w256_d16_A is

    -- component
    component reshape_fifo_w256_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_reshape_fifo_w256_d16_A_ram : reshape_fifo_w256_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity reshape_fifo_w256_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 256;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of reshape_fifo_w256_d16_A_ram is
