...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "concat.autotvin.dat"
	set constFileTvOut       "concat.autotvout.dat"
	set constFileHdlTvIn     "concat.autohdltvin.dat"
	set constFileHdlTvOut    "concat.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
