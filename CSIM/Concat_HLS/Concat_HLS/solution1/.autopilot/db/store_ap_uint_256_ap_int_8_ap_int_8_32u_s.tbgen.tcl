...
set C_modelArgList {
	...
	{ output_data_addr3 int 32 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "data_out1", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_data_addr3", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_out1_dout sc_in sc_lv 256 signal 0 } 
	{ data_out1_num_data_valid sc_in sc_lv 8 signal 0 } 
	{ data_out1_fifo_cap sc_in sc_lv 8 signal 0 } 
	{ data_out1_empty_n sc_in sc_logic 1 signal 0 } 
	{ data_out1_read sc_out sc_logic 1 signal 0 } 
	{ m_axi_concat_data_AWVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_AWREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_AWADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_concat_data_AWID sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_AWLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_concat_data_AWSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_concat_data_AWBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_concat_data_AWLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_concat_data_AWCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_AWPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_concat_data_AWQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_AWREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_AWUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_WVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_WREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_WDATA sc_out sc_lv 256 signal 1 } 
	{ m_axi_concat_data_WSTRB sc_out sc_lv 32 signal 1 } 
	{ m_axi_concat_data_WLAST sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_WID sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_WUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_ARVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_ARREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_ARADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_concat_data_ARID sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_ARLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_concat_data_ARSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_concat_data_ARBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_concat_data_ARLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_concat_data_ARCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_ARPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_concat_data_ARQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_ARREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_concat_data_ARUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_concat_data_RVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_RREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_RDATA sc_in sc_lv 256 signal 1 } 
	{ m_axi_concat_data_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_concat_data_RFIFONUM sc_in sc_lv 9 signal 1 } 
	{ m_axi_concat_data_RUSER sc_in sc_lv 1 signal 1 } 
	{ m_axi_concat_data_RRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_concat_data_BVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_concat_data_BREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_concat_data_BRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_concat_data_BID sc_in sc_lv 1 signal 1 } 
	{ m_axi_concat_data_BUSER sc_in sc_lv 1 signal 1 } 
	...
	{ output_data_addr3_dout sc_in sc_lv 32 signal 3 } 
	{ output_data_addr3_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ output_data_addr3_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ output_data_addr3_empty_n sc_in sc_logic 1 signal 3 } 
	{ output_data_addr3_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_out1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_out1", "role": "num_data_valid" }} , 
 	{ "name": "data_out1_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_out1", "role": "fifo_cap" }} , 
 	...
 	{ "name": "output_data_addr3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_data_addr3", "role": "dout" }} , 
 	{ "name": "output_data_addr3_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_data_addr3", "role": "num_data_valid" }} , 
 	{ "name": "output_data_addr3_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_data_addr3", "role": "fifo_cap" }} , 
 	{ "name": "output_data_addr3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_data_addr3", "role": "empty_n" }} , 
 	{ "name": "output_data_addr3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_data_addr3", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "5", "EstimateLatencyMax" : "134217770",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "data_out1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1_fu_102", "Port" : "data_out1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "concat_data", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1_fu_102", "Port" : "concat_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "output_data_addr3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1_fu_102", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2", "EstimateLatencyMax" : "134217767",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "zext_ln96", "Type" : "None", "Direction" : "I"},
			{"Name" : "outputs_load", "Type" : "None", "Direction" : "I"},
			{"Name" : "concat_data", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1_fu_102.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set ArgLastReadFirstWriteLatency {
	store_ap_uint_256_ap_int_8_ap_int_8_32u_s {
		...
		concat_data {Type O LastRead 4 FirstWrite 3}
		outputs {Type I LastRead 0 FirstWrite -1}
		output_data_addr3 {Type I LastRead 0 FirstWrite -1}
		ROWS {Type I LastRead 0 FirstWrite -1}
		COLS {Type I LastRead 0 FirstWrite -1}
		concat_flag {Type O LastRead -1 FirstWrite 3}}
	store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_91_1 {
		loop_num {Type I LastRead 0 FirstWrite -1}
		data_out1 {Type I LastRead 1 FirstWrite -1}
		zext_ln96 {Type I LastRead 0 FirstWrite -1}
		outputs_load {Type I LastRead 0 FirstWrite -1}
		concat_data {Type O LastRead 4 FirstWrite 3}
		count_out {Type O LastRead -1 FirstWrite 38}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5", "Max" : "134217770"}
	, {"Name" : "Interval", "Min" : "5", "Max" : "134217770"}
]}
...
set Spec2ImplPortList { 
	data_out1 { ap_fifo {  { data_out1_dout fifo_port_we 0 256 }  { data_out1_num_data_valid fifo_status_num_data_valid 0 8 }  { data_out1_fifo_cap fifo_update 0 8 }  { data_out1_empty_n fifo_status 0 1 }  { data_out1_read fifo_data 1 1 } } }
	...
	output_data_addr3 { ap_fifo {  { output_data_addr3_dout fifo_port_we 0 32 }  { output_data_addr3_num_data_valid fifo_status_num_data_valid 0 3 }  { output_data_addr3_fifo_cap fifo_update 0 3 }  { output_data_addr3_empty_n fifo_status 0 1 }  { output_data_addr3_read fifo_data 1 1 } } }
