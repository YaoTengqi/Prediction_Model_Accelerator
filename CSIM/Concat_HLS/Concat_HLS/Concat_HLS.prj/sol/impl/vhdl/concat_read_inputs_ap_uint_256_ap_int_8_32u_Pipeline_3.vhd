...
entity concat_read_inputs_ap_uint_256_ap_int_8_32u_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    p_cast8_cast : IN STD_LOGIC_VECTOR (58 downto 0);
    output_addr : IN STD_LOGIC_VECTOR (26 downto 0) );
end;


architecture behav of concat_read_inputs_ap_uint_256_ap_int_8_32u_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal concat_data_addr_2_read_reg_145 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal loop_index_fu_52 : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond3_fu_116_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1))) then 
                    loop_index_fu_52 <= empty_fu_110_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_fu_52 <= ap_const_lv27_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                concat_data_addr_2_read_reg_145 <= m_axi_concat_data_RDATA;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, exitcond3_fu_116_p2, ap_start_int)
    begin
        if (((exitcond3_fu_116_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    empty_fu_110_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv27_1));
    exitcond3_fu_116_p2 <= "1" when (empty_fu_110_p2 = output_addr) else "0";
    ...
    m_axi_concat_data_WDATA <= concat_data_addr_2_read_reg_145;
