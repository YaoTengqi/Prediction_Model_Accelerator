set moduleName store_ap_uint_256_ap_int_8_32u_Pipeline_VITIS_LOOP_103_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {store<ap_uint<256>, ap_int<8>, 32u>_Pipeline_VITIS_LOOP_103_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ concat_data int 256 regular {axi_master 1}  }
	{ sext_ln103 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "concat_data", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "inputs","offset": { "type": "dynamic","port_name": "inputs","bundle": "concat_addr"},"direction": "READONLY"},{"cName": "outputs","offset": { "type": "dynamic","port_name": "outputs","bundle": "concat_addr"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln103", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln103 sc_in sc_lv 59 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln103", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln103", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln103 { ap_none {  { sext_ln103 in_data 0 59 } } }
