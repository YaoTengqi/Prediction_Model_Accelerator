...
set C_modelArgList {
	...
	{ output_stream int 256 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ROWS", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_stream", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_stream_dout sc_in sc_lv 256 signal 3 } 
	{ output_stream_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ output_stream_fifo_cap sc_in sc_lv 7 signal 3 } 
	{ output_stream_empty_n sc_in sc_logic 1 signal 3 } 
	{ output_stream_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "output_stream", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			...
			{"Name" : "input_data_addr3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "input_data_addr3_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "output_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_ap_uint_256_ap_int_8_32u_Pipeline_VITIS_LOOP_103_1_fu_126", "Port" : "output_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "concat_data", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "concat_data_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "concat_data_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_ap_uint_256_ap_int_8_32u_Pipeline_VITIS_LOOP_103_1_fu_126", "Port" : "concat_data", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_ap_uint_256_ap_int_8_32u_Pipeline_VITIS_LOOP_103_1_fu_126", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_ap_uint_256_ap_int_8_32u_Pipeline_VITIS_LOOP_103_1_fu_126.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U104", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	output_stream { ap_fifo {  { output_stream_dout fifo_port_we 0 256 }  { output_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { output_stream_fifo_cap fifo_update 0 7 }  { output_stream_empty_n fifo_status 0 1 }  { output_stream_read fifo_data 1 1 } } }
