...
entity concat_fifo_w256_d128_A is
    generic (
...
architecture arch of concat_fifo_w256_d128_A is

    -- component
    component concat_fifo_w256_d128_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_concat_fifo_w256_d128_A_ram : concat_fifo_w256_d128_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity concat_fifo_w256_d128_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 256;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of concat_fifo_w256_d128_A_ram is
