set moduleName read_inputs_ap_uint_256_ap_int_8_32u_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {read_inputs<ap_uint<256>, ap_int<8>, 32u>_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ concat_data int 256 regular {axi_master 2}  }
	{ p_cast9_cast int 59 regular  }
	{ p_cast8_cast int 59 regular  }
	{ output_addr int 27 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "concat_data", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "inputs","offset": { "type": "dynamic","port_name": "inputs","bundle": "concat_addr"},"direction": "READONLY"},{"cName": "outputs","offset": { "type": "dynamic","port_name": "outputs","bundle": "concat_addr"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "p_cast8_cast", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "output_addr", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ p_cast8_cast sc_in sc_lv 59 signal 2 } 
	{ output_addr sc_in sc_lv 27 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_cast8_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "p_cast8_cast", "role": "default" }} , 
 	{ "name": "output_addr", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "output_addr", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	p_cast8_cast { ap_none {  { p_cast8_cast in_data 0 59 } } }
	output_addr { ap_none {  { output_addr in_data 0 27 } } }
}
