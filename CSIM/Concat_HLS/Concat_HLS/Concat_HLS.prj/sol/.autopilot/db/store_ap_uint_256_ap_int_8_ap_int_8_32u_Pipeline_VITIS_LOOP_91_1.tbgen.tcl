...
set C_modelArgMapList {[ 
	{ "Name" : "concat_data", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "inputs","offset": { "type": "dynamic","port_name": "inputs","bundle": "concat_addr"},"direction": "READONLY"},{"cName": "outputs","offset": { "type": "dynamic","port_name": "outputs","bundle": "concat_addr"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln91", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_out1_num_data_valid sc_in sc_lv 8 signal 3 } 
	{ data_out1_fifo_cap sc_in sc_lv 8 signal 3 } 
	...
	{ sext_ln91 sc_in sc_lv 59 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln91", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln91", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "134217730"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "134217730"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln91 { ap_none {  { sext_ln91 in_data 0 59 } } }
