; ModuleID = '/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Concat_HLS/Concat_HLS/Concat_HLS.prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_concat_ir(i32 %input_data_addr1, i32 %input_data_addr2, i32 %output_data_addr3, i32 %ROWS, i32 %COLS, i16 signext %mul1, i32 %shift1, i16 signext %mul2, i32 %shift2, %"struct.ap_uint<256>"* noalias nonnull %inputs, %"struct.ap_uint<256>"* noalias nocapture nonnull %outputs, i1* noalias nocapture nonnull dereferenceable(1) %concat_flag) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_concat_hw(i32 %input_data_addr1, i32 %input_data_addr2, i32 %output_data_addr3, i32 %ROWS, i32 %COLS, i16 %mul1, i32 %shift1, i16 %mul2, i32 %shift2, i256* %inputs_copy, i256* %outputs_copy, i1* %concat_flag_copy)
...
declare void @apatb_concat_hw(i32, i32, i32, i32, i32, i16, i32, i16, i32, i256*, i256*, i1*)
...
define void @concat_hw_stub_wrapper(i32, i32, i32, i32, i32, i16, i32, i16, i32, i256*, i256*, i1*) #4 {
entry:
  %12 = alloca %"struct.ap_uint<256>"
  %13 = alloca %"struct.ap_uint<256>"
  call void @copy_out(%"struct.ap_uint<256>"* %12, i256* %9, %"struct.ap_uint<256>"* %13, i256* %10, i1* null, i1* %11)
  call void @concat_hw_stub(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i16 %5, i32 %6, i16 %7, i32 %8, %"struct.ap_uint<256>"* %12, %"struct.ap_uint<256>"* %13, i1* %11)
  call void @copy_in(%"struct.ap_uint<256>"* %12, i256* %9, %"struct.ap_uint<256>"* %13, i256* %10, i1* null, i1* %11)
  ret void
}

declare void @concat_hw_stub(i32, i32, i32, i32, i32, i16, i32, i16, i32, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, i1*)
