...
module concat_read_inputs_ap_uint_256_ap_int_8_32u_Pipeline_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [255:0] concat_data_addr_2_read_reg_145;
reg    ap_block_pp0_stage0_01001;
reg   [26:0] loop_index_fu_52;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond3_fu_116_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
            loop_index_fu_52 <= empty_fu_110_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_52 <= 27'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond3_fu_116_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign empty_fu_110_p2 = (ap_sig_allocacmp_loop_index_load + 27'd1);

assign exitcond3_fu_116_p2 = ((empty_fu_110_p2 == output_addr) ? 1'b1 : 1'b0);
...
assign m_axi_concat_data_WDATA = concat_data_addr_2_read_reg_145;
...
endmodule //concat_read_inputs_ap_uint_256_ap_int_8_32u_Pipeline_3
