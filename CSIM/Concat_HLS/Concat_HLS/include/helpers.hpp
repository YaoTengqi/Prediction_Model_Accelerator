				 ...
				 bool &concat_flag)
{
	...
	memcpy(&outputs[0], (const t_AXI_DataType *)&inputs[input_data_addr1], ROWS * COLS * sizeof(t_DataType_OUT));
	memcpy(&outputs[output_addr], (const t_AXI_DataType *)&inputs[input_data_addr2], ROWS * COLS * sizeof(t_DataType_OUT));
	concat_flag = true;
}
