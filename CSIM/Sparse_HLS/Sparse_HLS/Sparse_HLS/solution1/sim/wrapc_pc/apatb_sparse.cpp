...
// wrapc file define:
#define AUTOTB_TVIN_input_data_addr1 "../tv/cdatafile/c.sparse.autotvin_input_data_addr1.dat"
#define AUTOTB_TVOUT_input_data_addr1 "../tv/cdatafile/c.sparse.autotvout_input_data_addr1.dat"
#define AUTOTB_TVIN_input_data_addr2 "../tv/cdatafile/c.sparse.autotvin_input_data_addr2.dat"
#define AUTOTB_TVOUT_input_data_addr2 "../tv/cdatafile/c.sparse.autotvout_input_data_addr2.dat"
#define AUTOTB_TVIN_output_data_addr3 "../tv/cdatafile/c.sparse.autotvin_output_data_addr3.dat"
#define AUTOTB_TVOUT_output_data_addr3 "../tv/cdatafile/c.sparse.autotvout_output_data_addr3.dat"
#define AUTOTB_TVIN_am_ROWS "../tv/cdatafile/c.sparse.autotvin_am_ROWS.dat"
#define AUTOTB_TVOUT_am_ROWS "../tv/cdatafile/c.sparse.autotvout_am_ROWS.dat"
#define AUTOTB_TVIN_am_COLS "../tv/cdatafile/c.sparse.autotvin_am_COLS.dat"
#define AUTOTB_TVOUT_am_COLS "../tv/cdatafile/c.sparse.autotvout_am_COLS.dat"
#define AUTOTB_TVIN_fm_ROWS "../tv/cdatafile/c.sparse.autotvin_fm_ROWS.dat"
#define AUTOTB_TVOUT_fm_ROWS "../tv/cdatafile/c.sparse.autotvout_fm_ROWS.dat"
#define AUTOTB_TVIN_fm_COLS "../tv/cdatafile/c.sparse.autotvin_fm_COLS.dat"
#define AUTOTB_TVOUT_fm_COLS "../tv/cdatafile/c.sparse.autotvout_fm_COLS.dat"
#define AUTOTB_TVIN_inputs "../tv/cdatafile/c.sparse.autotvin_inputs.dat"
...
#define AUTOTB_TVOUT_sparse_data "../tv/cdatafile/c.sparse.autotvout_sparse_data.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_sparse_flag "../tv/rtldatafile/rtl.sparse.autotvout_sparse_flag.dat"
#define AUTOTB_TVOUT_PC_sparse_data "../tv/rtldatafile/rtl.sparse.autotvout_sparse_data.dat"
...
void apatb_sparse_hw(hls::sim::Byte<4> __xlx_apatb_param_input_data_addr1, hls::sim::Byte<4> __xlx_apatb_param_input_data_addr2, hls::sim::Byte<4> __xlx_apatb_param_output_data_addr3, hls::sim::Byte<4> __xlx_apatb_param_am_ROWS, hls::sim::Byte<4> __xlx_apatb_param_am_COLS, hls::sim::Byte<4> __xlx_apatb_param_fm_ROWS, hls::sim::Byte<4> __xlx_apatb_param_fm_COLS, void* __xlx_apatb_param_inputs, void* __xlx_apatb_param_outputs, void* __xlx_apatb_param_sparse_flag)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_input_data_addr1),
#endif
  };
  port0.param = &__xlx_apatb_param_input_data_addr1;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_input_data_addr2),
#endif
  };
  port1.param = &__xlx_apatb_param_input_data_addr2;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_output_data_addr3),
#endif
  };
  port2.param = &__xlx_apatb_param_output_data_addr3;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_am_ROWS),
#endif
  };
  port3.param = &__xlx_apatb_param_am_ROWS;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_am_COLS),
#endif
  };
  port4.param = &__xlx_apatb_param_am_COLS;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_fm_ROWS),
#endif
  };
  port5.param = &__xlx_apatb_param_fm_ROWS;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_fm_COLS),
#endif
  };
  port6.param = &__xlx_apatb_param_fm_COLS;
  ...
  port7.param = &__xlx_offset_byte_param_inputs;
  ...
  static hls::sim::Register port9 {
    ...
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_sparse_flag),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_sparse_flag),
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_sparse_data),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_sparse_data),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_sparse_data),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_sparse_data),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_sparse_data),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_sparse_data),
#endif
#endif
  };
