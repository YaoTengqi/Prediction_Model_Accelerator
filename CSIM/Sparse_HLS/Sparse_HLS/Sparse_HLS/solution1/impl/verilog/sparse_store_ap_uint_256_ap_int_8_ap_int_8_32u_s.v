...
wire  signed [63:0] sext_ln88_fu_184_p1;
reg    ap_block_state1;
reg   [0:0] sparse_flag_preg;
wire   [0:0] icmp_ln95_fu_194_p2;
wire   [31:0] mul_ln85_fu_134_p2;
wire   [36:0] shl_ln_fu_158_p3;
wire   [63:0] zext_ln88_fu_165_p1;
wire   [63:0] add_ln88_fu_169_p2;
reg   [40:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state41))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0)) & (icmp_ln95_fu_194_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state41))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state41) & (icmp_ln88_reg_223 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln85_reg_218[26 : 0] <= zext_ln85_fu_150_p1[26 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        loop_num_reg_209 <= {{mul_ln85_fu_134_p2[31:5]}};
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln88_fu_153_p2 == 1'd0))) begin
        trunc_ln1_reg_227 <= {{add_ln88_fu_169_p2[63:5]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0))) begin
...
always @ (*) begin
    if ((~((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state41))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state41) & (icmp_ln88_reg_223 == 1'd0))) begin
...
always @ (*) begin
    if ((~((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state41) & (icmp_ln88_reg_223 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (grp_store_ap_uint_256_ap_int_8_ap_int_8_32u_Pipeline_VITIS_LOOP_88_1_fu_124_ap_done == 1'b1))) begin
...
assign add_ln88_fu_169_p2 = (outputs_read_reg_199 + zext_ln88_fu_165_p1);
...
always @ (*) begin
    ap_block_state41 = ((icmp_ln88_reg_223 == 1'd0) & (m_axi_sparse_data_BVALID == 1'b0));
end
...
assign icmp_ln88_fu_153_p2 = ((loop_num_reg_209 == 27'd0) ? 1'b1 : 1'b0);

assign icmp_ln95_fu_194_p2 = ((ap_phi_mux_count_0_lcssa_phi_fu_117_p4 == loop_num_reg_209) ? 1'b1 : 1'b0);
...
assign sext_ln88_fu_184_p1 = $signed(trunc_ln1_reg_227);

assign shl_ln_fu_158_p3 = {{output_data_addr3_read_reg_204}, {5'd0}};

assign zext_ln85_fu_150_p1 = loop_num_reg_209;

assign zext_ln88_fu_165_p1 = shl_ln_fu_158_p3;

always @ (posedge ap_clk) begin
    zext_ln85_reg_218[31:27] <= 5'b00000;
end
