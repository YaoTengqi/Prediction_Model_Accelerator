...
set portList { 
	...
	{ outputs sc_in sc_lv 64 signal 0 } 
	{ outputs_c_din sc_out sc_lv 64 signal 1 } 
	{ outputs_c_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ outputs_c_fifo_cap sc_in sc_lv 4 signal 1 } 
	{ outputs_c_full_n sc_in sc_logic 1 signal 1 } 
	{ outputs_c_write sc_out sc_logic 1 signal 1 } 
	{ quant_shift sc_in sc_lv 32 signal 2 } 
	{ quant_shift_c_din sc_out sc_lv 32 signal 3 } 
	{ quant_shift_c_num_data_valid sc_in sc_lv 4 signal 3 } 
	{ quant_shift_c_fifo_cap sc_in sc_lv 4 signal 3 } 
	{ quant_shift_c_full_n sc_in sc_logic 1 signal 3 } 
	{ quant_shift_c_write sc_out sc_logic 1 signal 3 } 
	{ quant_mul sc_in sc_lv 32 signal 4 } 
	{ quant_mul_c_din sc_out sc_lv 32 signal 5 } 
	{ quant_mul_c_num_data_valid sc_in sc_lv 4 signal 5 } 
	{ quant_mul_c_fifo_cap sc_in sc_lv 4 signal 5 } 
	{ quant_mul_c_full_n sc_in sc_logic 1 signal 5 } 
	{ quant_mul_c_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "quant_shift_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "quant_shift_c", "role": "num_data_valid" }} , 
 	{ "name": "quant_shift_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "quant_shift_c", "role": "fifo_cap" }} , 
 	...
 	{ "name": "quant_mul_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "quant_mul_c", "role": "num_data_valid" }} , 
 	{ "name": "quant_mul_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "quant_mul_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "outputs_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "outputs_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "quant_shift", "Type" : "None", "Direction" : "I"},
			{"Name" : "quant_shift_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "quant_shift_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "quant_mul", "Type" : "None", "Direction" : "I"},
			{"Name" : "quant_mul_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	quant_shift_c { ap_fifo {  { quant_shift_c_din fifo_port_we 1 32 }  { quant_shift_c_num_data_valid fifo_status_num_data_valid 0 4 }  { quant_shift_c_fifo_cap fifo_update 0 4 }  { quant_shift_c_full_n fifo_status 0 1 }  { quant_shift_c_write fifo_data 1 1 } } }
	quant_mul { ap_none {  { quant_mul in_data 0 32 } } }
	quant_mul_c { ap_fifo {  { quant_mul_c_din fifo_port_we 1 32 }  { quant_mul_c_num_data_valid fifo_status_num_data_valid 0 4 }  { quant_mul_c_fifo_cap fifo_update 0 4 }  { quant_mul_c_full_n fifo_status 0 1 }  { quant_mul_c_write fifo_data 1 1 } } }
}
