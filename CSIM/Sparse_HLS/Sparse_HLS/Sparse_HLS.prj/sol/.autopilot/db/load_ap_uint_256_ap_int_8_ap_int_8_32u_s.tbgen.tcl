...
set C_modelArgList {
	...
	{ idx_stream4 int 8 regular {fifo 1 volatile }  }
	{ count_stream5 int 8 regular {fifo 1 volatile }  }
	{ fm_stream3 int 256 regular {fifo 1 volatile }  }
	{ input_data_addr1 int 32 regular  }
	{ input_data_addr2 int 32 regular  }
	{ am_ROWS_c int 32 regular {fifo 1}  }
	{ fm_ROWS_c11 int 32 regular {fifo 1}  }
	{ fm_COLS_c13 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "am_ROWS", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "idx_stream4", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "count_stream5", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "fm_stream3", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "fm_ROWS_c11", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "fm_COLS_c13", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ idx_stream4_din sc_out sc_lv 8 signal 6 } 
	{ idx_stream4_num_data_valid sc_in sc_lv 8 signal 6 } 
	{ idx_stream4_fifo_cap sc_in sc_lv 8 signal 6 } 
	{ idx_stream4_full_n sc_in sc_logic 1 signal 6 } 
	{ idx_stream4_write sc_out sc_logic 1 signal 6 } 
	{ count_stream5_din sc_out sc_lv 8 signal 7 } 
	{ count_stream5_num_data_valid sc_in sc_lv 7 signal 7 } 
	{ count_stream5_fifo_cap sc_in sc_lv 7 signal 7 } 
	{ count_stream5_full_n sc_in sc_logic 1 signal 7 } 
	{ count_stream5_write sc_out sc_logic 1 signal 7 } 
	{ fm_stream3_din sc_out sc_lv 256 signal 8 } 
	{ fm_stream3_num_data_valid sc_in sc_lv 8 signal 8 } 
	{ fm_stream3_fifo_cap sc_in sc_lv 8 signal 8 } 
	{ fm_stream3_full_n sc_in sc_logic 1 signal 8 } 
	{ fm_stream3_write sc_out sc_logic 1 signal 8 } 
	...
	{ fm_ROWS_c11_din sc_out sc_lv 32 signal 12 } 
	{ fm_ROWS_c11_num_data_valid sc_in sc_lv 3 signal 12 } 
	{ fm_ROWS_c11_fifo_cap sc_in sc_lv 3 signal 12 } 
	{ fm_ROWS_c11_full_n sc_in sc_logic 1 signal 12 } 
	{ fm_ROWS_c11_write sc_out sc_logic 1 signal 12 } 
	{ fm_COLS_c13_din sc_out sc_lv 32 signal 13 } 
	{ fm_COLS_c13_num_data_valid sc_in sc_lv 2 signal 13 } 
	{ fm_COLS_c13_fifo_cap sc_in sc_lv 2 signal 13 } 
	{ fm_COLS_c13_full_n sc_in sc_logic 1 signal 13 } 
	{ fm_COLS_c13_write sc_out sc_logic 1 signal 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idx_stream4_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "idx_stream4", "role": "din" }} , 
 	...
 	{ "name": "idx_stream4_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "idx_stream4", "role": "full_n" }} , 
 	{ "name": "idx_stream4_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "idx_stream4", "role": "write" }} , 
 	{ "name": "count_stream5_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "count_stream5", "role": "din" }} , 
 	...
 	{ "name": "count_stream5_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count_stream5", "role": "full_n" }} , 
 	{ "name": "count_stream5_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count_stream5", "role": "write" }} , 
 	{ "name": "fm_stream3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "fm_stream3", "role": "din" }} , 
 	...
 	{ "name": "fm_stream3_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_stream3", "role": "full_n" }} , 
 	{ "name": "fm_stream3_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_stream3", "role": "write" }} , 
 	...
 	{ "name": "fm_ROWS_c11_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fm_ROWS_c11", "role": "din" }} , 
 	{ "name": "fm_ROWS_c11_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "fm_ROWS_c11", "role": "num_data_valid" }} , 
 	{ "name": "fm_ROWS_c11_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "fm_ROWS_c11", "role": "fifo_cap" }} , 
 	{ "name": "fm_ROWS_c11_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_ROWS_c11", "role": "full_n" }} , 
 	{ "name": "fm_ROWS_c11_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_ROWS_c11", "role": "write" }} , 
 	{ "name": "fm_COLS_c13_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fm_COLS_c13", "role": "din" }} , 
 	{ "name": "fm_COLS_c13_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "fm_COLS_c13", "role": "num_data_valid" }} , 
 	{ "name": "fm_COLS_c13_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "fm_COLS_c13", "role": "fifo_cap" }} , 
 	{ "name": "fm_COLS_c13_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_COLS_c13", "role": "full_n" }} , 
 	{ "name": "fm_COLS_c13_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_COLS_c13", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "idx_stream4", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "idx_stream4_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "count_stream5", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "count_stream5_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fm_stream3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "fm_ROWS_c11", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "fm_ROWS_c11_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fm_COLS_c13", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U9", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U10", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_325_8_1_1_U11", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	idx_stream4 { ap_fifo {  { idx_stream4_din fifo_port_we 1 8 }  { idx_stream4_num_data_valid fifo_status_num_data_valid 0 8 }  { idx_stream4_fifo_cap fifo_update 0 8 }  { idx_stream4_full_n fifo_status 0 1 }  { idx_stream4_write fifo_data 1 1 } } }
	count_stream5 { ap_fifo {  { count_stream5_din fifo_port_we 1 8 }  { count_stream5_num_data_valid fifo_status_num_data_valid 0 7 }  { count_stream5_fifo_cap fifo_update 0 7 }  { count_stream5_full_n fifo_status 0 1 }  { count_stream5_write fifo_data 1 1 } } }
	fm_stream3 { ap_fifo {  { fm_stream3_din fifo_port_we 1 256 }  { fm_stream3_num_data_valid fifo_status_num_data_valid 0 8 }  { fm_stream3_fifo_cap fifo_update 0 8 }  { fm_stream3_full_n fifo_status 0 1 }  { fm_stream3_write fifo_data 1 1 } } }
	...
	fm_ROWS_c11 { ap_fifo {  { fm_ROWS_c11_din fifo_port_we 1 32 }  { fm_ROWS_c11_num_data_valid fifo_status_num_data_valid 0 3 }  { fm_ROWS_c11_fifo_cap fifo_update 0 3 }  { fm_ROWS_c11_full_n fifo_status 0 1 }  { fm_ROWS_c11_write fifo_data 1 1 } } }
	fm_COLS_c13 { ap_fifo {  { fm_COLS_c13_din fifo_port_we 1 32 }  { fm_COLS_c13_num_data_valid fifo_status_num_data_valid 0 2 }  { fm_COLS_c13_fifo_cap fifo_update 0 2 }  { fm_COLS_c13_full_n fifo_status 0 1 }  { fm_COLS_c13_write fifo_data 1 1 } } }
}
