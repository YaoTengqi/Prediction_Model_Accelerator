...
set C_modelArgList {
	...
	{ fm_ram int 8 regular {array 16384 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fm_ram", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fm_ram_address0 sc_out sc_lv 14 signal 2 } 
	{ fm_ram_ce0 sc_out sc_logic 1 signal 2 } 
	{ fm_ram_q0 sc_in sc_lv 8 signal 2 } 
	{ fm_ram_address1 sc_out sc_lv 14 signal 2 } 
	{ fm_ram_ce1 sc_out sc_logic 1 signal 2 } 
	{ fm_ram_q1 sc_in sc_lv 8 signal 2 } 
	...
	{ data_out1_num_data_valid sc_in sc_lv 10 signal 5 } 
	{ data_out1_fifo_cap sc_in sc_lv 10 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fm_ram_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "fm_ram", "role": "q0" }} , 
 	{ "name": "fm_ram_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "fm_ram", "role": "address1" }} , 
 	{ "name": "fm_ram_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_ram", "role": "ce1" }} , 
 	{ "name": "fm_ram_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "fm_ram", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "data_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	fm_ram { ap_memory {  { fm_ram_address0 mem_address 1 14 }  { fm_ram_ce0 mem_ce 1 1 }  { fm_ram_q0 in_data 0 8 }  { fm_ram_address1 MemPortADDR2 1 14 }  { fm_ram_ce1 MemPortCE2 1 1 }  { fm_ram_q1 in_data 0 8 } } }
	...
	data_out1 { ap_fifo {  { data_out1_din fifo_port_we 1 256 }  { data_out1_num_data_valid fifo_status_num_data_valid 0 10 }  { data_out1_fifo_cap fifo_update 0 10 }  { data_out1_full_n fifo_status 0 1 }  { data_out1_write fifo_data 1 1 } } }
