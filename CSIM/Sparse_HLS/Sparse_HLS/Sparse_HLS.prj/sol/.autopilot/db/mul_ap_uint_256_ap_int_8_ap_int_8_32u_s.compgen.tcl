...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename idx_ram \
    op interface \
    ports { idx_ram_address0 { O 10 vector } idx_ram_ce0 { O 1 bit } idx_ram_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename count_ram \
    op interface \
    ports { count_ram_address0 { O 5 vector } count_ram_ce0 { O 1 bit } count_ram_q0 { I 8 vector } } \
} "
} else {
