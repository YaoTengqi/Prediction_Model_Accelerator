...
set C_modelArgList {
	...
	{ fm_COLS_c15 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "am_ROWS", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fm_COLS_c15", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fm_COLS_c15_din sc_out sc_lv 32 signal 6 } 
	{ fm_COLS_c15_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ fm_COLS_c15_fifo_cap sc_in sc_lv 2 signal 6 } 
	{ fm_COLS_c15_full_n sc_in sc_logic 1 signal 6 } 
	{ fm_COLS_c15_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fm_COLS_c15_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fm_COLS_c15", "role": "din" }} , 
 	{ "name": "fm_COLS_c15_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "fm_COLS_c15", "role": "num_data_valid" }} , 
 	{ "name": "fm_COLS_c15_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "fm_COLS_c15", "role": "fifo_cap" }} , 
 	{ "name": "fm_COLS_c15_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_COLS_c15", "role": "full_n" }} , 
 	{ "name": "fm_COLS_c15_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_COLS_c15", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "fm_COLS_c15", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	fm_COLS_c15 { ap_fifo {  { fm_COLS_c15_din fifo_port_we 1 32 }  { fm_COLS_c15_num_data_valid fifo_status_num_data_valid 0 2 }  { fm_COLS_c15_fifo_cap fifo_update 0 2 }  { fm_COLS_c15_full_n fifo_status 0 1 }  { fm_COLS_c15_write fifo_data 1 1 } } }
}
