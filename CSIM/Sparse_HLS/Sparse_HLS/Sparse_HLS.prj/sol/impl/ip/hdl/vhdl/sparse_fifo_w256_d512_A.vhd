...
entity sparse_fifo_w256_d512_A is
    generic (
...
architecture arch of sparse_fifo_w256_d512_A is

    -- component
    component sparse_fifo_w256_d512_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_sparse_fifo_w256_d512_A_ram : sparse_fifo_w256_d512_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity sparse_fifo_w256_d512_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 256;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of sparse_fifo_w256_d512_A_ram is
