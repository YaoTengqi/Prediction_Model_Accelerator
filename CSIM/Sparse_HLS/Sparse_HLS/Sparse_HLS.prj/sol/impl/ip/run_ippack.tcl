...
set IPName      "sparse"
set Version     "1.0"
set DisplayName "Sparse"
set Revision    "2113603316"
...
set xo_kernel_name "sparse"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Sparse_HLS/Sparse_HLS/Sparse_HLS.prj/sol"
set debug_dir "/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Sparse_HLS/Sparse_HLS/Sparse_HLS.prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {sparse_mul_32s_32s_32_1_1
...
sparse_flow_control_loop_pipe_sequential_init
sparse_fifo_w64_d6_S
sparse_fifo_w32_d5_S
sparse_fifo_w32_d5_S
sparse_fifo_w27_d2_S
sparse_fifo_w27_d2_S
sparse_fifo_w27_d5_S
sparse_fifo_w8_d128_S
sparse_fifo_w8_d64_S
sparse_fifo_w256_d128_A
sparse_fifo_w32_d2_S
sparse_fifo_w32_d3_S
sparse_fifo_w32_d2_S
sparse_fifo_w1024_d64_A
sparse_fifo_w32_d2_S
sparse_fifo_w256_d2_S
sparse_fifo_w32_d2_S
sparse_fifo_w32_d2_S
sparse_start_for_quant_ap_uint_256_ap_int_32_ap_int_8_32u_U0
sparse_start_for_mul_ap_uint_256_ap_int_32_ap_int_8_ap_int_8_32u_U0
...
set Interfaces {
    s_axi_sparse_addr {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_sparse_addr"
        param_prefix "C_S_AXI_SPARSE_ADDR"
        addr_bits "7"
        port_width "AWADDR 7 WDATA 32 WSTRB 4 ARADDR 7 RDATA 32"
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 input_data_addr1 W 0x0 "Data signal of input_data_addr1" {{0 32 input_data_addr1 W 0 "Bit 31 to 0 of input_data_addr1"}}} {0x18 input_data_addr2 W 0x0 "Data signal of input_data_addr2" {{0 32 input_data_addr2 W 0 "Bit 31 to 0 of input_data_addr2"}}} {0x20 output_data_addr3 W 0x0 "Data signal of output_data_addr3" {{0 32 output_data_addr3 W 0 "Bit 31 to 0 of output_data_addr3"}}} {0x28 am_ROWS W 0x0 "Data signal of am_ROWS" {{0 32 am_ROWS W 0 "Bit 31 to 0 of am_ROWS"}}} {0x30 am_COLS W 0x0 "Data signal of am_COLS" {{0 32 am_COLS W 0 "Bit 31 to 0 of am_COLS"}}} {0x38 fm_ROWS W 0x0 "Data signal of fm_ROWS" {{0 32 fm_ROWS W 0 "Bit 31 to 0 of fm_ROWS"}}} {0x40 fm_COLS W 0x0 "Data signal of fm_COLS" {{0 32 fm_COLS W 0 "Bit 31 to 0 of fm_COLS"}}} {0x48 inputs_1 W 0x0 "Data signal of inputs" {{0 32 inputs W 0 "Bit 31 to 0 of inputs"}}} {0x4c inputs_2 W 0x0 "Data signal of inputs" {{0 32 inputs W 0 "Bit 63 to 32 of inputs"}}} {0x54 outputs_1 W 0x0 "Data signal of outputs" {{0 32 outputs W 0 "Bit 31 to 0 of outputs"}}} {0x58 outputs_2 W 0x0 "Data signal of outputs" {{0 32 outputs W 0 "Bit 63 to 32 of outputs"}}} {0x60 quant_shift W 0x0 "Data signal of quant_shift" {{0 32 quant_shift W 0 "Bit 31 to 0 of quant_shift"}}} {0x68 quant_mul W 0x0 "Data signal of quant_mul" {{0 32 quant_mul W 0 "Bit 31 to 0 of quant_mul"}}} {0x70 sparse_flag R 0x0 "Data signal of sparse_flag" {{0 1 sparse_flag R 0 "Bit 0 to 0 of sparse_flag"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 sparse_flag_ctrl R 0x0 "Control signal of sparse_flag" {{0 1 sparse_flag_ap_vld R 0 "Control signal sparse_flag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_sparse_addr m_axi_sparse_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_sparse_data {
        ...
        data_width "256"
        port_prefix "m_axi_sparse_data"
        param_prefix "C_M_AXI_SPARSE_DATA"
        ...
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_sparse_addr"
    }
}
...
source -notrace "/home/ytq/source/Xilinx/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
