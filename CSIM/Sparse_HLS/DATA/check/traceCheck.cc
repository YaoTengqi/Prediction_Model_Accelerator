...
int main()
{
    FILE *pd_true = NULL;
    FILE *pd_mine = NULL;
    pd_true = fopen("/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Sparse_HLS/DATA/data/dram_before.bin", "rb");
    pd_mine = fopen("/home/ytq/codeField/Prediction_Model_Accelerator/CSIM/Sparse_HLS/DATA/data/dram_after.bin", "rb");
    int begin = 0;
    int addr = begin;
